...
function renderNavbar() {
    document.querySelectorAll('[data-component="navbar"]').forEach((mount) => {
      ...
      <header class="navbar">
        <div class="container">
          <div class="nav-inner">
            <a class="nav-logo" href="index.html" aria-label="PixelForge home">
              <span class="logo-mark"><img src="assets/icons/sparkles.svg" alt="PixelForge logo icon"></span>
        ...
        <div class="container">
          <div class="footer-grid">
            <div class="footer-brand">
              ...
              <p>AI-ready digital service company specializing in modern websites, eCommerce, UI/UX, analytics, and scalable web development for startups and growing brands.</p>
          ...
          <div class="footer-bottom">© 2026 PixelForge Agency. All rights reserved.</div>
        </div>
      </footer>`;
    });
}
...
/*function initTheme() {
    ...
    document.querySelectorAll("[data-theme-toggle]").forEach(button => {
        ...
        button.addEventListener("click", () => {
            ...
            document.querySelectorAll("[data-theme-toggle]").forEach(btn => btn.textContent = nextTheme === "dark" ? "☀" : "☾");
        });
    });
}*/
        ...
        .forEach(button => {
            ...
            button.innerHTML =
                savedTheme === "dark"
                    ? `
                    <img
                      src="asstes/icons/crescent-moon.svg"
                      alt="Light mode icon"
                    >
                    `
                    : `
                    <img
                      src="asstes/icons/sun.svg"
                      alt="Dark mode icon"
                    >
                    `;
    ...
    document.querySelectorAll("[data-contact-form]").forEach(form => {
        form.addEventListener("submit", async event => {
            ...
            try {
                ...
                if (response.ok) {
                    form.reset();
                    if (success) { success.textContent = "Thanks! Your message has been sent successfully."; success.classList.add("show"); }
                } else if (success) {
                    success.textContent = "FormSubmit may need first-time email activation. Please check your inbox.";
                    success.classList.add("show");
                }
            } catch (err) {
                if (success) { success.textContent = "Network issue. Please try again or email us directly."; success.classList.add("show"); }
            }
        });
    });
}
